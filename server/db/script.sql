...
insert into questions (questionText, difficulty, teacherId, categoryId) values ('why do cats cross the street', '10', 1, 1);
insert into questions (questionText, difficulty, teacherId, categoryId) values ('why do mice cross the street', '1', 1, 1);
